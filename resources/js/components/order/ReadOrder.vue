<template>
  <div class="orderReadConteer row justify-content-md-center">
    ...
    <div class="col-md-8 col-md-offset-2" v-if="order.status==4">
      <div class="card">
        <div class="card-body">
        ...
        <div class="card-body collapse" id="collapseExample">
          ...
          <div class="row mb-4" v-for="(serial,index) in serials">
            ...
            <div class="col-md-4">
              <input
                class="form-control"
                @input="setValue(index,'serial',$event)"
                :value="serial.serial"
            ...
            <div class="col-md-3">
              <input
                class="form-control"
                @input="setValue(index,'link',$event)"
                :value="serial.link"
                placeholder="Link"
              />
            </div>
            <div class="col-md-4">
              <textarea
                class="form-control"
                @input="setValue(index,'text',$event)"
                :value="serial.text"
                placeholder="Text"
              ></textarea>
            </div>
    ...
    <div class="col-md-8 col-md-offset-2" v-if="order.status==3">
      <div class="card">
        <div class="card-body">
          ...
          <div class="pt-2 pb-2">
            <textarea
              class="form-control"
              @input="setValueSerial(0,'commentAll',$event)"
              :value="order.comment=='0'?'':order.comment"
            ></textarea>
          </div>
          <div class="pt-2 pb-2">
          ...
          <div class="row mb-4" v-for="(serial,index) in order.serials">
            ...
            <div class="col-md-4">
              <input
                class="form-control"
                @input="setValueSerial(index,'serial',$event)"
                :value="serial.serial"
                placeholder="Serial number"
              />
            </div>
            <div class="col-md-3">
              <input
                class="form-control"
                @input="setValueSerial(index,'link',$event)"
                :value="serial.link"
                placeholder="Link"
              />
            </div>
            <div class="col-md-4">
              <textarea
                class="form-control"
                @input="setValueSerial(index,'text',$event)"
                :value="serial.text"
                placeholder="Text"
              ></textarea>
            </div>
        ...
        <div class="card-body collapse" id="collapseExample2">
          <div class="form-group">
            <select class="form-control" ref="changeDoneSelect">
              <option v-for="(item,index) in failed" :value="index" :key="index">{{item}}</option>
            </select>
          </div>
          <div class="form-group">
