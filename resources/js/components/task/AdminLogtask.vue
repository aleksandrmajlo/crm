                  ...
                  {{ orderlog.admin_id }}
                        ...
                        <td>
                            <div v-if="orderlog.text">
                                <div
                                    v-if="
                      orderlog.status_id == 2 ||
                      orderlog.status_id == 4 ||
                      orderlog.status_id == 7
                    "
                                >
                                    <p v-if="orderlog.text.done.commentall !== undefined">
                                        <strong>Comment:</strong
                                        >{{ orderlog.text.done.commentall }}
                                    </p>
                                    <div v-if="orderlog.text.done.serials.length > 0">
                                        <div
                                            class="mb-2"
                                            v-for="(serial, ind) in orderlog.text.done.serials"
                                            :key="ind"
                                        >
                                            <div class="">
                                                <short-serial :serial="serial.serial"></short-serial>
                                            </div>
                                            <div class=""><b>Link:</b> {{ serial.link }}</div>
                                            <div class=""><b>Text:</b>{{ serial.text }}</div>
                                            <hr/>
                                        </div>
                                    </div>
                                </div>
                                <div
                                    v-else-if="
                      orderlog.status_id == 3 ||
                      orderlog.status_id == 5 ||
                      orderlog.status_id == 6
                    "
                                >
                                    <p><strong>Type:</strong> {{ orderlog.failedStatus }}</p>
                                    <div>
                                ...
                                <div v-else-if="orderlog.status_id == 11">
                                    ...
                                    <p>
                                        <strong>Show:</strong>
                                        {{ orderlog.text.showcommentadmin }}
                                    </p>
                                </div>
                                <div
                                    v-else-if="orderlog.status_id == 14 || orderlog.status_id == 15"
                                >
                                    <p>
                                        {{ orderlog.text.text }}
                                    </p>
